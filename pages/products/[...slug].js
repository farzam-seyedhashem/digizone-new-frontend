            ...
            <div className={" bg-surface-light dark:bg-surface-dark"}>
                <div
                    ...
                    <div>
                        ...
                        {productCategories.data.map(category => <Link href={"/products/" + category.slug} key={category._id}
                ...
                <div className={"py-6 px-6"}>
                    ...
                    <div className={"grid grid-cols-12 gap-4"}>
                        ...
                        <div className={"col-span-3"}>
                            <div className={"bg-surface-container-high-light dark:bg-surface-container-high-dark w-full p-6 rounded-[24px]"}>
